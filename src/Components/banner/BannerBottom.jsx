...
const BannerBottom = () => {
  return (
    <div className="p-20 bg-linear-to-r from-[#4F39F6] to-[#9514FA]">
      <div className="max-mx text-center flex flex-col md:flex-row justify-center items-center gap-10 md:gap-35 text-white">
